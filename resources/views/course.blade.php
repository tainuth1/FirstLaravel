    ...
    <section class="popular-course">
        ...
        <div class="grid-1x3 container-width">
            ...
            <div class="course-card">
                ...
                <p>Back-end is a course that you need to learn after you finished the Front-end developer. <br> This course can make you become a full stack Web developer that make you have high salary.</p>
                <div class="btn-container">
                    <a class="btn-one" href="#">Learn now</a>
